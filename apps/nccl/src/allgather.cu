...
void AllgatherAlgo6::initialize(std::shared_ptr<mscclpp::Communicator> comm) { this->conns_ = setupConnections(comm); }
...
AllgatherAlgo8::AllgatherAlgo8() : scratchBuffer_(scratchBufferSize_) {}
