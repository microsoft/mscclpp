...
## Generated Json File
The python based DSL will generate a json file. The json file will contain the execution plan for the MSCCL++ runtime. The json file will be used to execute the kernel on the device. 
