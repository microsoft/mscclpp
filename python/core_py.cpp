...
NB_MODULE(mscclpp, m) {
  ...
  nb::class_<TcpBootstrap, Bootstrap>(m, "TcpBootstrap")
    ...
    .def_static("create", [](int rank, int nRanks) { return std::make_shared<TcpBootstrap>(rank, nRanks); }, nb::arg("rank"), nb::arg("nRanks"))
    ...
    .def("initialize", (void (TcpBootstrap::*)(const std::string&)) &TcpBootstrap::initialize, nb::arg("ifIpPortTrio"));
  ...
  nb::class_<Connection>(m, "Connection")
    ...
    .def("update_and_sync", &Connection::updateAndSync, nb::arg("dst"), nb::arg("dstOffset"), nb::arg("src"), nb::arg("newValue"))
  ...
  nb::class_<Communicator>(m, "Communicator")
    ...
    .def("send_memory_on_setup", &Communicator::sendMemoryOnSetup, nb::arg("memory"), nb::arg("remoteRank"), nb::arg("tag"))
    .def("recv_memory_on_setup", &Communicator::recvMemoryOnSetup, nb::arg("remoteRank"), nb::arg("tag"))
    .def("connect_on_setup", &Communicator::connectOnSetup, nb::arg("remoteRank"), nb::arg("tag"), nb::arg("transport"))
