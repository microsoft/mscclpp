...
NB_MODULE(mscclpp_ep_cpp, m) {
  ...
  nb::class_<mscclpp::ep::MoERuntime>(m, "MoERuntime")
      ...
      .def(
          ...
          nb::arg("num_experts"), nb::arg("quant_mode"), nb::arg("output_layout"), nb::arg("stream_ptr"))
      .def(
          "combine",
          [](mscclpp::ep::MoERuntime& self, uintptr_t expertOutputPtr, uintptr_t expertScalesPtr, uintptr_t topkIdxPtr,
             ...
             int numTokens, int hidden, int numTopk, int numMaxDispatchTokensPerRank, int numExperts, int quantMode,
             uintptr_t streamPtr) {
            self.combine(ptr(outputPtr), ptr(expertOutputPtr), reinterpret_cast<float*>(ptr(expertScalesPtr)),
                         ...
                         numTokens, hidden, numTopk, numMaxDispatchTokensPerRank, numExperts, quantMode,
                         stream(streamPtr));
          },
          ...
          nb::arg("num_tokens"), nb::arg("hidden"), nb::arg("num_topk"), nb::arg("num_max_dispatch_tokens_per_rank"),
          nb::arg("num_experts"), nb::arg("quant_mode"), nb::arg("stream_ptr"));
