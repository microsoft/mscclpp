...
NB_MODULE(mscclpp_ep_cpp, m) {
  ...
  nb::class_<mscclpp::ep::MoERuntime>(m, "MoERuntime")
      ...
      .def(
          "dispatch",
          [](mscclpp::ep::MoERuntime& self, uintptr_t inputPtr, uintptr_t inputScalesPtr, uintptr_t topkIdxPtr,
             ...
             int numExperts, int quantMode, mscclpp::ep::DispatchLayout outputLayout, uintptr_t streamPtr) {
            self.dispatch(ptr(outputPtr), reinterpret_cast<float*>(ptr(outputScalesPtr)),
                          ...
                          reinterpret_cast<int*>(ptr(outputCountPtr)), ptr(inputPtr), ptr(inputScalesPtr),
                          reinterpret_cast<int64_t*>(ptr(topkIdxPtr)), numTokens, hidden, numTopk,
                          numMaxDispatchTokensPerRank, numExperts, quantMode, outputLayout, stream(streamPtr));
          },
          nb::arg("input_ptr"), nb::arg("input_scales_ptr"), nb::arg("topk_idx_ptr"), nb::arg("output_ptr"),
          ...
          nb::arg("num_max_dispatch_tokens_per_rank"), nb::arg("num_experts"), nb::arg("quant_mode"),
      ...
      .def(
          ...
          [](mscclpp::ep::MoERuntime& self, uintptr_t expertOutputPtr, uintptr_t topkIdxPtr, uintptr_t topkWeightsPtr,
             ...
             int numTopk, int numMaxDispatchTokensPerRank, int numExperts, uintptr_t streamPtr) {
            self.combine(ptr(outputPtr), ptr(expertOutputPtr), reinterpret_cast<int64_t*>(ptr(topkIdxPtr)),
                         ...
                         numMaxDispatchTokensPerRank, numExperts, stream(streamPtr));
          },
          ...
          nb::arg("num_topk"), nb::arg("num_max_dispatch_tokens_per_rank"), nb::arg("num_experts"),
          nb::arg("stream_ptr"));
