  ...
  nb::class_<mscclpp::ep::MoERuntime>(m, "MoERuntime")
      ...
      .def(
          ...
          [](mscclpp::ep::MoERuntime& self, uintptr_t inputPtr, uintptr_t topkIdxPtr, uintptr_t topkWeightsPtr,
             ...
             bool initializeTokenMajorPadding, mscclpp::ep::low_latency::DispatchDataType dispatchDataType,
            ...
            self.dispatch(ptr(outputPtr), reinterpret_cast<float*>(ptr(outputScalesPtr)),
                          ...
                          numTokens, hidden, numTopk, maxTokensPerRank, numExperts, dispatchLayout,
                          initializeTokenMajorPadding, dispatchDataType, numBlocks, stream(streamPtr));
          },
          ...
          nb::arg("num_experts"), nb::arg("dispatch_layout"), nb::arg("initialize_token_major_padding"),
