...
void ExecutionKernel::launchKernel(int rank, int nthreadblocks, int nthreads, void* src, void* dst, void* scratch, size_t constOffsetIn, size_t constOffsetOut,
...
template void ExecutionKernel::launchKernel<LL16Packet>(int rank, int nthreadblocks, int nthreads, void* src, void* dst,
                                                        void* scratch, size_t constOffsetIn, size_t constOffsetOut, size_t scratchSize, DataType dataType,
